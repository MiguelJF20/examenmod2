 ...
 * @author Lenovo
 */
@WebServlet(name = "LogueoOrtega", urlPatterns = {"/logueoortega"})
public class LogueoOrtega extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            GoogleIdTokenVerifier verifier = new GoogleIdTokenVerifier.Builder(new NetHttpTransport(), new GsonFactory())
                    .setAudience(Collections.singletonList("989193315801-gqv9jq8mont5cdtvhiucjreitp757d83.apps.googleusercontent.com"))
                    .build();
